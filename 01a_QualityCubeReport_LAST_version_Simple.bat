...
SET PYTHONPATH=
REM SET PYTHONPATH=C:\Python\Python313\
...
SET CMD="%PYTHONCMD%" "%~dp0QualityCubeReport.py" -versionFilter LAST -detailLevel Simple -log "%OUTPUTFOLDER%\QualityCubeReport.log" -extensioninstallationfolder "%EXTENSIONINSTALLATIONFOLDER%" -apikey %APIKEY%
ECHO Running %CMD%
%CMD%
